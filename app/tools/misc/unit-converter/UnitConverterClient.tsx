      ...
      <main className="flex-grow container mx-auto px-4 py-12">
        ...
        <div className="bg-gray-800 rounded-xl shadow-lg p-8 max-w-4xl mx-auto mb-8">
          ...
          <ul className="list-disc list-inside text-gray-300 mb-4">
            <li>🔄 <strong>Multiple Categories:</strong> Convert units across length, weight, temperature, volume, and area.</li>
            <li>⚡ <strong>Real-time Conversion:</strong> See results instantly as you type.</li>
            <li>🔀 <strong>Unit Swapping:</strong> Easily switch between 'from' and 'to' units with one click.</li>
            <li>📋 <strong>Copy to Clipboard:</strong> Quickly copy conversion results for use elsewhere.</li>
            <li>📜 <strong>Conversion History:</strong> Keep track of your recent conversions.</li>
            <li>🖥️ <strong>Responsive Design:</strong> Use on any device, from desktop to mobile.</li>
          ...
          <ul className="list-disc list-inside text-gray-300 space-y-2">
            ...
            <li>For area convers
ions, be mindful of the difference between square units (e.g., square meters) and non-square units (e.g., acres).</li>
          </ul>
        </div>
      </main>
      <Footer />
