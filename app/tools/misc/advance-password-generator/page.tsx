    ...
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-gray-900 to-gray-800">
      ...
      <main className="flex-grow container mx-auto px-4 py-12">
            ...
            <div>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center space-x-2">
                  <Checkbox id="lowercase" checked={useLowercase} onChange={setUseLowercase} />
                  <Label htmlFor="lowercase" className="text-white">Include Lowercase</Label>
                </div>

                <div className="flex items-center space-x-2">
                  <Checkbox id="uppercase" checked={useUppercase} onChange={setUseUppercase} />
                  <Label htmlFor="uppercase" className="text-white">Include Uppercase</Label>
                </div>

                <div className="flex items-center space-x-2">
                  <Checkbox id="numbers" checked={useNumbers} onChange={setUseNumbers} />
                  <Label htmlFor="numbers" className="text-white">Include Numbers</Label>
                </div>

                <div className="flex items-center space-x-2">
                  <Checkbox id="symbols" checked={useSymbols} onChange={setUseSymbols} />
                  <Label htmlFor="symbols" className="text-white">Include Symbols</Label>
                </div>

                <div className="flex items-center space-x-2 relative">
                    <Checkbox id="Exclude-Similar" checked={excludeSimilar} onChange={setExcludeSimilar} />
                ...
                <div className="flex items-center space-x-2 relative">
                    <Checkbox id="Exclude-Ambiguous" checked={excludeAmbiguous} onChange={setExcludeAmbiguous} />
                ...
                <div className="flex items-center space-x-2">
                  <Checkbox id="Require-every-type" checked={requireEveryType} onChange={setRequireEveryType} />
                  <Label htmlFor="require-every-type" className="text-white"></Label>
                </div>

                <div className="flex items-center space-x-2">
                  <Checkbox id="begin-with-letter" checked={beginWithLetter} onChange={setBeginWithLetter} />
                  <Label htmlFor="begin-with-letter" className="text-white">Begin With a Letter</Label>
                </div>

                <div className="flex items-center space-x-2">
                  <Checkbox id="no-consecutive" checked={noConsecutive} onChange={setNoConsecutive} />
                ...
                <div className="flex items-center space-x-2">
                  <Checkbox id="use-custom-charset" checked={useCustomCharSet} onChange={setUseCustomCharSet} />
        ...
        <div className="bg-gray-800 rounded-xl shadow-lg p-8 max-w-4xl mx-auto">
          <h2 className="text-2xl font-bold text-white mb-4">Password Security Tips</h2>
