...
import { Copy, RefreshCw, Download, Undo, Redo } from 'lucide-react'
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-gray-900 to-gray-800">
      ...
      <main className="flex-grow container mx-auto px-4 py-8">
        <h1 className="text-4xl font-bold text-white mb-8 text-center">CSS Border Radius Generator</h1>
                ...
                <TabsContent value="corners" className="space-y-4">
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <Select value={unit} onValueChange={(value: BorderRadiusUnit) => setUnit(value)}>
                      <SelectTrigger id="unit" className="w-14 bg-gray-700 text-white border-gray-600">
          ...
          <div className="mt-8">
            ...
            <div className="mt-4 flex flex-wrap justify-between items-center">
              <div className="space-x-2 mb-2 sm:mb-0">
                <Button onClick={handleUndo} variant="outline" className="text-white border-white hover:bg-gray-700" disabled={historyIndex <= 0}>
                  <Undo className="h-5 w-5 mr-2" />
                  Undo
                </Button>
                <Button onClick={handleRedo} variant="outline" className="text-white border-white hover:bg-gray-700" disabled={historyIndex >= history.length - 1}>
