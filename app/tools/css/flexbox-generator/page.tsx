  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-gray-900 to-gray-800">
      ...
      <main className="flex-grow container mx-auto px-4 py-8">
        <h1 className="text-4xl font-bold text-white mb-8 text-center">CSS Flexbox Generator</h1>
        ...
        <div className="bg-gray-800 rounded-xl shadow-lg p-8 max-w-4xl mx-auto mb-8">
          <div className="mb-8">
            ...
            <div>
              <h2 className="text-2xl mt-4 font-bold text-white mb-4">Container Settings</h2>
              ...
              <h2 className="text-2xl font-bold text-white mt-8 mb-4">Item Settings</h2>
              <div className="space-y-4">
                {items.map((item, index) => (
        ...
        <div className="bg-gray-800 rounded-xl shadow-lg p-8 max-w-4xl mx-auto mb-8">
          ...
          <ol className="list-decimal list-inside text-gray-300 space-y-2">
            <li>Adjust the container settings to change the overall flexbox layout.</li>
            <li>Modify individual item settings to control their behavior within the flexbox.</li>
            <li>Add or remove items using the buttons provided.</li>
            <li>Customize colors for the container and individual items.</li>
            <li>Preview the flexbox layout in real-time in the preview area.</li>
        ...
        <div className="bg-gray-800 rounded-xl shadow-lg p-8 max-w-4xl mx-auto">
          ...
          <ul className="list-disc list-inside text-gray-300 space-y-2">
            <li>Real-time preview of flexbox layout</li>
            <li>Customizable container properties (flex-direction, justify-content, align-items, flex-wrap)</li>
            <li>Customizable item properties (flex-grow, flex-shrink, flex-basis, align-self)</li>
            <li>Add and remove flex items dynamically</li>
