...
.glitch::before {
  ...
  text-shadow: -${intensity * 0.2}px 0 ${color1};
  animation: glitch-effect ${speed}s infinite linear alternate-reverse;
}
.glitch::after {
  left: -${intensity * 0.2}px;
  text-shadow: ${intensity * 0.2}px 0 ${color2};
  animation: glitch-effect ${speed * 1.1}s infinite linear alternate-reverse;
}
@keyframes glitch-effect {
  0% { clip: rect(${intensity * 5}px, 9999px, ${intensity * 10}px, 0); transform: skew(${intensity * 0.1}deg); }
  5% { clip: rect(${intensity * 15}px, 9999px, ${intensity * 20}px, 0); transform: skew(${intensity * 0.2}deg); }
  10% { clip: rect(${intensity * 25}px, 9999px, ${intensity * 30}px, 0); transform: skew(${intensity * 0.1}deg); }
  15% { clip: rect(${intensity * 35}px, 9999px, ${intensity * 40}px, 0); transform: skew(${intensity * 0.2}deg); }
  20% { clip: rect(${intensity * 45}px, 9999px, ${intensity * 50}px, 0); transform: skew(${intensity * 0.1}deg); }
  25% { clip: rect(${intensity * 55}px, 9999px, ${intensity * 60}px, 0); transform: skew(${intensity * 0.2}deg); }
  30% { clip: rect(${intensity * 65}px, 9999px, ${intensity * 70}px, 0); transform: skew(${intensity * 0.1}deg); }
  35% { clip: rect(${intensity * 75}px, 9999px, ${intensity * 80}px, 0); transform: skew(${intensity * 0.2}deg); }
  40% { clip: rect(${intensity * 85}px, 9999px, ${intensity * 90}px, 0); transform: skew(${intensity * 0.1}deg); }
  45% { clip: rect(${intensity * 95}px, 9999px, ${intensity * 100}px, 0); transform: skew(${intensity * 0.2}deg); }
  50% { clip: rect(${intensity * 105}px, 9999px, ${intensity * 110}px, 0); transform: skew(${intensity * 0.1}deg); }
  55% { clip: rect(${intensity * 115}px, 9999px, ${intensity * 120}px, 0); transform: skew(${intensity * 0.2}deg); }
  60% { clip: rect(${intensity * 125}px, 9999px, ${intensity * 130}px, 0); transform: skew(${intensity * 0.1}deg); }
  65% { clip: rect(${intensity * 135}px, 9999px, ${intensity * 140}px, 0); transform: skew(${intensity * 0.2}deg); }
  70% { clip: rect(${intensity * 145}px, 9999px, ${intensity * 150}px, 0); transform: skew(${intensity * 0.1}deg); }
  75% { clip: rect(${intensity * 155}px, 9999px, ${intensity * 160}px, 0); transform: skew(${intensity * 0.2}deg); }
  80% { clip: rect(${intensity * 165}px, 9999px, ${intensity * 170}px, 0); transform: skew(${intensity * 0.1}deg); }
  85% { clip: rect(${intensity * 175}px, 9999px, ${intensity * 180}px, 0); transform: skew(${intensity * 0.2}deg); }
  90% { clip: rect(${intensity * 185}px, 9999px, ${intensity * 190}px, 0); transform: skew(${intensity * 0.1}deg); }
  95% { clip: rect(${intensity * 195}px, 9999px, ${intensity * 200}px, 0); transform: skew(${intensity * 0.2}deg); }
  100% { clip: rect(${intensity * 205}px, 9999px, ${intensity * 210}px, 0); transform: skew(${intensity * 0.1}deg); }
}
@keyframes glitch-skew {
  0% { transform: skew(0deg); }
  20% { transform: skew(${intensity * 0.2}deg); }
  40% { transform: skew(-${intensity * 0.1}deg); }
  60% { transform: skew(${intensity * 0.3}deg); }
  80% { transform: skew(-${intensity * 0.2}deg); }
...
${generatedCSS}
        ...
        <div className="bg-gray-800 rounded-xl shadow-lg p-4 md:p-8 max-w-4xl mx-auto mt-8">
          ...
          <ol className="list-decimal list-inside text-gray-300 space-y-2 text-sm md:text-base">
            ...
            <li>Choose a glitch effect type from the dropdown menu (RGB Split, Color, Noise, Transformation, or Custom).</li>
