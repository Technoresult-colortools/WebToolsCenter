...
import { Copy, Download, Plus, Minus, RotateCcw, Shuffle } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-gray-900 to-gray-800">
      ...
      <main className="flex-grow container mx-auto px-4 py-8">
        <h1 className="text-3xl md:text-4xl font-bold text-white mb-8 text-center">Color Gradient Generator</h1>
        ...
        <div className="bg-gray-800 shadow-lg rounded-lg p-6 max-w-4xl mx-auto">
          <h2 className="text-2xl font-semibold text-white mb-4">About Color Gradient Generator</h2>
          <p className="text-white mb-6">
            The Color Gradient Generator is a powerful tool that allows you to create custom CSS gradients with ease. 
            Whether you're a web designer, developer, or just someone who loves playing with colors, this tool provides 
            an intuitive interface to generate beautiful linear, radial, and conic gradients.
          </p>
