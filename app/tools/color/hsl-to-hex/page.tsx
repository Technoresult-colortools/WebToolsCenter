        ...
        <div className="bg-gray-800 rounded-xl shadow-lg p-8 max-w-2xl mx-auto">
          <div className="mt-8">
            <section className="mb-6">
              <h2 className="text-xl font-semibold text-white mb-2">About HSL to Hex Converter</h2>
              <p className="text-white">
                This tool allows you to convert HSL (Hue, Saturation, Lightness) color values to their Hexadecimal (Hex) equivalent.
                Hex codes are often used in web design and development to specify colors.
              </p>
            </section>
            ...
            <section className="mb-6">
              ...
              <p className="text-white">
                ...
                4. Click the &quot;Convert&quot; button to see the Hex equivalent and a color preview.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-white">
                ...
                - Lightness represents the brightness from 0% (black) to 100% (white).<br />
                - The resulting Hex code is commonly used in web design.
              </p>
            </section>
          </div>
        </div>
