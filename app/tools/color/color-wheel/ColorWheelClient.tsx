    ...
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-gray-900 to-gray-800">
      ...
      <main className="flex-grow container mx-auto px-4 py-12">
        <h1 className="text-4xl font-bold text-white mb-8 text-center">Color Wheel</h1>
            <div className="bg-gray-800 shadow-lg rounded-lg p-8 mb-6 max-w-4xl mx-auto">
            ...
            <div className="bg-gray-800 shadow-lg rounded-lg p-8 max-w-4xl mx-auto">
              <div className="space-y-6">
                <section>
                  <h2 className="text-2xl font-semibold text-white mb-2">About Color Wheel</h2>
                  <p className="text-white">
                    The Color Wheel is a visual representation of color theory that shows the relationships between colors. It's an essential tool for designers, artists, and anyone working with color. Our interactive Color Wheel tool allows you to explore color harmonies, generate palettes, and understand color relationships in a user-friendly interface.
                  </p>
                </section>
