      ...
      <main className="flex-grow container mx-auto px-4 py-12">
        ...
        <div className="bg-gray-800 shadow-lg rounded-lg p-8 max-w-4xl mx-auto">
          <div className="space-y-6">
            <section>
              <h2 className="text-2xl font-semibold text-white mb-2">About HSV to RGB Converter</h2>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-white mb-2">How to Use HSV to RGB Converter?</h2>
