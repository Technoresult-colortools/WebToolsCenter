        ...
        <div className="bg-gray-800 rounded-xl shadow-lg p-8 max-w-2xl mx-auto">
          <div className="mt-8">
            <section className="mb-6">
              <h2 className="text-xl font-semibold text-white mb-2">About HSV to Hex Converter</h2>
              <p className="text-white">
                This tool allows you to convert HSV (Hue, Saturation, Value) color values to their Hexadecimal equivalent.
                HSV is a common representation of the RGB color model, where the hue defines the color, saturation its intensity, and value its brightness.
              </p>
            </section>
            ...
            <section className="mb-6">
              ...
              <p className="text-white">
                1. Enter the Hue value between 0 and 359.<br />
                2. Enter the Saturation value between 0 and 100.<br />
                3. Enter the Value (brightness) value between 0 and 100.<br />
                4. Click the &quot;Convert&quot; button to see the Hexadecimal equivalent and a color preview.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-white">
                - Hue is represented as a degree on the color wheel from 0 to 359.<br />
                - Saturation is the intensity of the color from 0% to 100%.<br />
                - Value represents the brightness from 0% (black) to 100% (full brightness).<br />
                - The resulting Hex value represents the RGB color in Hexadecimal format.
              </p>
            </section>
          </div>
        </div>
