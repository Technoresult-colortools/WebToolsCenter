  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-gray-900 to-gray-800">
      ...
      <main className="flex-grow container mx-auto px-4 py-8">
        <h1 className="text-3xl md:text-4xl font-bold text-white mb-8 text-center">Image Color Extractor</h1>
            ...
            {!image ? (
              ...
              >
                <label
                  ref={dropZoneRef}
                  htmlFor="file-upload"
                  className="flex flex-col items-center justify-center h-48 md:h-96 px-4 py-6 bg-gray-700 text-blue-400 rounded-lg shadow-lg tracking-wide uppercase border-2 border-blue-400 border-dashed cursor-pointer hover:bg-blue-400 hover:text-white transition duration-300"
                >
                  <Upload size={38} />
        ...
        <div className="bg-gray-800 rounded-xl shadow-lg p-4 md:p-8 max-w-4xl mx-auto">
          <section className="mb-6">
            <h2 className="text-2xl font-bold text-white mb-4">About Image Color Extractor</h2>
            <p className="text-white">
              The Image Color Extractor is a powerful tool designed to analyze images and extract their dominant colors. 
              It's perfect for designers, artists, and anyone working with visual content who needs to quickly identify 
              and use color palettes from images.
            </p>
          </section>

          <section className="mb-6">
            <h2 className="text-2xl font-bold text-white mb-4">How to Use Image Color Extractor?</h2>
