          ...
          {showColorDetails && selectedColor && (
            <div className="mt-6 bg-gray-700 rounded-lg p-4 md:p-6 shadow-lg">
              <div className="flex items-center justify-between mb-4">
                ...
                <Button onClick={resetSelection} variant="destructive" className="bg-gray-600 text-white hover:bg-gray-500">
              ...
              <div className="flex items-center space-x-4 mb-4">
                ...
                <Button onClick={() => copyToClipboard(getColorString(selectedColor))} variant="default" size="sm" className="bg-gray-600 text-white hover:bg-gray-500">
                  Copy
                </Button>
              </div>
