      ...
      <main className="flex-grow container mx-auto px-4 py-12">
        ...
        <div className="bg-gray-800 shadow-lg rounded-lg p-8 mt-4 max-w-2xl mx-auto">
          <div className="space-y-6">
            <section>
              <h2 className="text-xl font-semibold text-white mb-2">About Color Mixer</h2>
              <p className="text-white">
                This tool allows you to mix two colors and see the gradients between them. You can input hex codes directly or use the color picker to select colors.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-white">
                1. Enter hex codes or use the color pickers to select start and end colors.&lt;br /&gt;
                2. Adjust the number of steps for the gradient using the slider.&lt;br /&gt;
                3. The mixed colors will update automatically.&lt;br /&gt;
                4. Click on the copy icon to copy any color&apos;s hex code.&lt;br /&gt;
                5. Use &quot;Random Colors&quot; for inspiration or &quot;Reset&quot; to start over.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-white">
                - Use complementary colors for striking gradients.&lt;br /&gt;
                - Experiment with different step counts to see varied transitions.&lt;br /&gt;
                - Use the random color feature to discover unexpected color combinations.
              </p>
            </section>
          </div>
        </div>
