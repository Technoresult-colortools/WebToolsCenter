      ...
      <main className="flex-grow container mx-auto px-4 py-12">
        ...
        <div className="bg-gray-800 rounded-xl shadow-lg p-4 md:p-8 max-w-4xl mx-auto">
          <section className="mb-6">
            <h2 className="text-2xl font-bold text-white mb-4">About RGBA to Hex Converter</h2>
          ...
          <section className="mb-6">
            <h2 className="text-2xl font-bold text-white mb-4">How to Use RGBA to Hex Converter?</h2>
