...
import { Upload, Download, RefreshCw, Maximize2, Minimize2, Image as ImageIcon, RotateCcw, RotateCw, ZoomIn, ZoomOut } from 'lucide-react'
    ...
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-gray-900 to-gray-800">
      ...
      <main className="flex-grow container mx-auto px-4 py-12">
        ...
        <div className="bg-gray-800 rounded-xl shadow-lg p-8 max-w-4xl mx-auto mt-8">
          <h2 className="text-2xl font-bold text-white mb-4">About Instagram Filters</h2>
