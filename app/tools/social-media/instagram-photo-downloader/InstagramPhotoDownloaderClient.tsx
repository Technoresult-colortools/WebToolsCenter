  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-gray-900 to-gray-800">
      ...
      <main className="flex-grow container mx-auto px-4 py-8">
        <h1 className="text-3xl font-bold text-white mb-6 text-center">Instagram Photo Downloader</h1>
        ...
        <div className="bg-gray-800 rounded-xl shadow-lg p-8 max-w-4xl mx-auto mt-8">
          <h2 className="text-2xl font-bold text-white mb-4">About Instagram Photo Downloader</h2>
          <p className="text-gray-300 mb-4">
            Our Instagram Photo Downloader is a powerful tool designed to help you save and manage Instagram content easily. 
            Whether you're looking to download photos from posts or gather information about public profiles, this tool provides 
            a user-friendly interface to accomplish these tasks quickly and efficiently.
          </p>
