    ...
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-gray-900 to-gray-800">
      ...
      <main className="flex-grow container mx-auto px-4 py-8">
        ...
        <div className="bg-gray-800 rounded-xl shadow-lg p-8 max-w-4xl mx-auto mt-8">
          <h2 className="text-2xl font-bold text-white mb-4">About YouTube Thumbnail Downloader</h2>
          <p className="text-gray-300 mb-4">
            Our YouTube Thumbnail Downloader is an easy-to-use tool designed to help you download high-quality thumbnails from any YouTube video. 
            Whether you are a content creator, marketer, or just need the perfect thumbnail for your collection, this tool provides a fast and 
