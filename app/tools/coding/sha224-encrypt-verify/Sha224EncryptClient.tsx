...
export default function SHA224EncryptVerify() {
  ...
  useEffect(() => {
    const savedPresets = localStorage.getItem('sha224Presets')
    if (savedPresets) {
      setPresets(JSON.parse(savedPresets))
    }
  }, [])

  const generateSHA224 = () => {
    try {
      ...
      toast.success('SHA-224 hash generated successfully!')
    } catch (error) {
      console.error('Error generating SHA-224:', error)
      toast.error('Error generating SHA-224 hash. Please check your input and encoding.')
    }
  }
  ...
  const handleDownload = () => {
    ...
    element.download = 'sha224_hash.txt'
    document.body.appendChild(element)
    element.click()
    document.body.removeChild(element)
    toast.success('SHA-224 hash downloaded!')
  }
  ...
  const savePreset = () => {
    ...
    if (presetName) {
      ...
      localStorage.setItem('sha224Presets', JSON.stringify(newPresets))
  ...
  return (
    <ToolLayout
      title="SHA-224 Hash Generator and Verifier"
    ...
    >
      ...
      <div className="bg-gray-800 rounded-xl shadow-lg p-4 md:p-8 max-w-4xl mx-auto mb-8">
        <Tabs defaultValue="generate" className="w-full">
          <TabsList className="grid w-full grid-cols-2 mb-4">
            <TabsTrigger value="generate">Generate SHA-224</TabsTrigger>
            <TabsTrigger value="verify">Verify SHA-224</TabsTrigger>
          </TabsList>
            ...
            <div className="space-y-4">
              <div>
                ...
                <div className="relative">
                  <Textarea
                    id="input-text"
                    placeholder="Enter text to generate SHA-224 hash..."
                    value={input}
              ...
              <div>
                <Label htmlFor="output-hash" className="text-white mb-2 block">SHA-224 Hash</Label>
                <Input
                  id="output-hash"
                  value={output}
                  readOnly
            ...
            <div className="space-y-4">
              <div>
                ...
                <div className="relative">
                  <Textarea
                    id="input-text"
                    placeholder="Enter text to verify SHA-224 hash..."
                    value={input}
                    onChange={handleInputChange}
                    className="w-full h-40 bg-gray-700 text-white border-gray-600 rounded-md p-2 pr-10"
              ...
              <div>
                <Label htmlFor="generated-hash" className="text-white mb-2 block">Generated SHA-224 Hash</Label>
                <Input
                  id="generated-hash"
                  value={output}
                  readOnly
              ...
              <div>
                ...
                <Input
                  id="compare-hash"
                  placeholder="Enter SHA-224 hash to compare..."
                  value={compareHash}
        ...
        <div className="mt-4 flex flex-wrap gap-2">
          <Button onClick={generateSHA224} className="bg-blue-600 hover:bg-blue-700">
      ...
      <CardContent>
        ...
        <div className="my-8">
          <Image 
            src="/Images/SSH224HashPreview.png?height=400&width=600"  
            alt="Screenshot of the SHA-224 Hash Generator and Verifier interface" 
            width={600} 
            height={400}
        ...
        <ol className="list-decimal list-inside text-gray-300 space-y-2 text-sm md:text-base">
          ...
          <li>Click 'Generate SHA-224' to create the hash value.</li>
        ...
        <ul className="list-disc list-inside text-gray-300 space-y-2 text-sm md:text-base">
          <li>Generate SHA-224 hashes from text input or file content</li>
          <li>Verify and compare SHA-224 hashes</li>
        ...
        <ul className="list-disc list-inside text-gray-300 space-y-2 text-sm md:text-base">
          <li>SHA-224 is considered cryptographically secure, but for highest security requirements, consider using SHA-256 or SHA-3.</li>
          ...
          <li>Be aware that while SHA-224 is secure for most applications, it may not be suitable for long-term data protection against future advances in computing power.</li>
        </ul>
        ...
        <ul className="list-disc list-inside text-gray-300 space-y-2 text-sm md:text-base">
          ...
          <li><strong>Blockchain and Cryptocurrencies:</strong> Some blockchain implementations use SHA-224 as part of their hashing algorithms.</li>
          <li><strong>Random Number Generation:</strong> Seed random number generators for cryptographic applications.</li>
        ...
        <ul className="list-disc list-inside text-gray-300 space-y-2 text-sm md:text-base">
          ...
          <li>Implement slow hash functions (e.g., bcrypt, Argon2) for password hashing instead of fast algorithms like SHA-224.</li>
          ...
          <li>Educate your team about the strengths and limitations of different hashing algorithms.</li>
          <li>Implement additional security measures, such as rate limiting, to prevent brute-force attacks.</li>
          <li>Consider using SHA-256 for applications requiring long-term security or dealing with larger data sets.</li>
        </ul>
