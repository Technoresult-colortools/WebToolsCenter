...
import { FileLock, FileLock2, Upload, Copy, RefreshCw, Info } from 'lucide-react'
    ...
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-gray-900 to-gray-800">
      ...
      <main className="flex-grow container mx-auto px-4 py-8">
        ...
        <Card className="bg-gray-800 rounded-xl shadow-lg p-6 md:p-8 max-w-4xl mx-auto mt-8">
          <CardContent className="space-y-8">
            <section>
              <h2 className="text-2xl font-semibold text-white mb-4">About Base64 Encoder/Decoder</h2>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-white mb-4">How to Use Base64 Encoder/Decoder?</h2>
              <ol className="list-decimal list-inside text-gray-300 space-y-2">
                ...
                <ul className="list-disc list-inside ml-4 mt-2 space-y-1">
                  ...
                  <li>Select a file from your device (max {MAX_FILE_SIZE_MB}MB, PNG/JPEG/TXT).</li>
