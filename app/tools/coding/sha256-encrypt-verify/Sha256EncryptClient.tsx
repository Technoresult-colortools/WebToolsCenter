    ...
    >
      ...
      <div className="bg-gray-800 rounded-xl shadow-lg p-4 md:p-8 max-w-4xl mx-auto mb-8">
        <Tabs defaultValue="generate" className="w-full">
          <TabsList className="grid w-full grid-cols-2 mb-4">
            <TabsTrigger value="generate">Generate SHA-256</TabsTrigger>
            <TabsTrigger value="verify">Verify SHA-256</TabsTrigger>
          </TabsList>
          <TabsContent value="generate">
            <div className="space-y-4">
              ...
              <div>
                <Label htmlFor="output-hash" className="text-white mb-2 block">SHA-256 Hash</Label>
                <Input
                  id="output-hash"
                  value={output}
                  readOnly
          ...
          <TabsContent value="verify">
            <div className="space-y-4">
              ...
              <div>
                <Label htmlFor="generated-hash" className="text-white mb-2 block">Generated SHA-256 Hash</Label>
                <Input
                  id="generated-hash"
                  value={output}
                  readOnly
        ...
        <div className="mt-4 flex flex-wrap gap-2">
          <Button onClick={generateSHA256} className="bg-blue-600 hover:bg-blue-700">
      ...
      <CardHeader>
        <CardTitle className="text-xl md:text-2xl font-semibold text-white mb-4 flex items-center">
          ...
          About SHA-256 Hash Generator and Verifier
        </CardTitle>
      </CardHeader>
      <CardContent>
        <p className="text-gray-300 mb-4">
          The SHA-256 Hash Generator and Verifier is a comprehensive tool designed for developers, security enthusiasts, and anyone working with data integrity verification. It provides a user-friendly interface to generate, verify, and manipulate SHA-256 hashes, ensuring that your data remains intact and unaltered during transmission or storage.
        </p>
        <p className="text-gray-300 mb-4">
          SHA-256 is part of the SHA-2 family of cryptographic hash functions, designed by the U.S. National Security Agency (NSA). It produces a 256-bit (32-byte) hash value, making it one of the most secure and widely used hash algorithms available today.
        </p>

        <div className="my-8">
          <Image 
            src="/Images/SHA256HashPreview.png?height=400&width=600"  
            alt="Screenshot of the SHA-256 Hash Generator and Verifier interface" 
            width={600} 
            height={400}
        ...
        <h2 className="text-xl md:text-2xl font-semibold text-white mb-4 mt-8 flex items-center">
          ...
          How to Use the SHA-256 Hash Generator and Verifier?
        </h2>
        ...
        <ul className="list-disc list-inside text-gray-300 space-y-2 text-sm md:text-base">
          ...
          <li>Verify and compare SHA-256 hashes</li>
        ...
        <ul className="list-disc list-inside text-gray-300 space-y-2 text-sm md:text-base">
          <li>SHA-256 is considered cryptographically secure and is widely used in various security applications.</li>
          ...
          <li>While SHA-256 is secure for most applications, consider using SHA-3 for the highest security requirements or future-proofing.</li>
        ...
        <ul className="list-disc list-inside text-gray-300 space-y-2 text-sm md:text-base">
          ...
          <li><strong>Blockchain and Cryptocurrencies:</strong> Many blockchain implementations use SHA-256 as their hashing algorithm.</li>
          ...
          <li><strong>Version Control Systems:</strong> Git uses SHA-256 for its object naming.</li>
        </ul>
        ...
        <ul className="list-disc list-inside text-gray-300 space-y-2 text-sm md:text-base">
          ...
          <li>For password hashing, use specialized algorithms like bcrypt, Argon2, or PBKDF2 instead of raw SHA-256.</li>
