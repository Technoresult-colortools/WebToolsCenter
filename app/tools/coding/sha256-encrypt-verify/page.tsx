      ...
      <main className="flex-grow container mx-auto px-4 py-8">
        ...
        <div className="bg-gray-800 rounded-xl shadow-lg p-4 md:p-8 max-w-4xl mx-auto mt-8">
          ...
          <ul className="list-disc list-inside text-gray-300 space-y-2 text-sm md:text-base">
            <li>SHA256 is a cryptographic hash function that produces a 256-bit (32-byte) hash value.</li>
            <li>It's widely used for digital signatures, file integrity verification, and password hashing.</li>
            <li>SHA256 is considered very secure and is part of the SHA-2 family of hash functions.</li>
            ...
            <li>SHA256 is more secure than SHA224 and is recommended for most applications requiring strong security.</li>
          </ul>
        </div>
      </main>
      <Footer />
