    ...
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-gray-900 to-gray-800">
      ...
      <main className="flex-grow container mx-auto px-4 py-8">
        ...
        <div className="bg-gray-800 rounded-xl shadow-lg p-6 md:p-8 max-w-4xl mx-auto mt-8">
          <h2 className="text-2xl font-semibold text-white mb-4">About Code to Image Converter</h2>
          <p className="text-gray-300 mb-4">
            The Code to Image Converter is a powerful tool designed to transform your code snippets into visually appealing, shareable images. Whether you're a developer looking to showcase your work on social media, create tutorials, or simply want to present your code in a more engaging format, this tool provides a quick and easy solution.
          </p>

          <h2 className="text-2xl font-semibold text-white mb-4 mt-8">How to Use Code to Image Converter?</h2>
          <ol className="list-decimal list-inside text-gray-300 space-y-2">
            ...
            <li>Choose a theme that best suits your code and preferences.</li>
            <li>Customize the background (gradient, solid color, or image).</li>
            <li>Adjust the layout to fit your needs (wide, compact, or square).</li>
            <li>Optionally add a watermark and customize its position.</li>
          ...
          <h2 className="text-2xl font-semibold text-white mb-4 mt-8">Key Features</h2>
          <ul className="list-disc list-inside text-gray-300 space-y-2">
            <li>Support for multiple programming languages with syntax highlighting</li>
            <li>Various color themes to match different coding styles and preferences</li>
            <li>Customizable backgrounds including gradients, solid colors, and images</li>
            <li>Flexible layout options (wide, compact, square) for different use cases</li>
            <li>Watermark functionality for branding or attribution</li>
            <li>Fullscreen preview for a better view of the final result</li>
            <li>Easy export to PNG format for sharing and use in various platforms</li>
          </ul>

          <h2 className="text-2xl font-semibold text-white mb-4 mt-8">Tips and Tricks</h2>
          <ul className="list-disc list-inside text-gray-300 space-y-2">
            <li>Use the compact layout for shorter code snippets or when sharing on platforms with size restrictions.</li>
            <li>Experiment with different background gradients to make your code stand out.</li>
            <li>For a clean, professional look, try using a solid color background that complements your code theme.</li>
            <li>When using a background image, choose one that doesn't distract from the code itself.</li>
            <li>Adjust the theme to match the style of the platform where you're sharing the image (e.g., dark theme for dark mode interfaces).</li>
            <li>Use the watermark feature to add your name, website, or social media handle for easy attribution.</li>
            <li>For consistency across multiple shared snippets, stick to a single theme and background style.</li>
            <li>When sharing tutorials or explanations, consider adding comments in your code to provide context within the image.</li>
            <li>Use the fullscreen preview to check how your image will appear on different devices and adjust accordingly.</li>
            <li>Remember to choose a file name that describes your code snippet for easy reference when exporting.</li>
          </ul>
        </div>
      </main>
      <Footer />
