      ...
      <main className="flex-grow container mx-auto px-4 py-8">
        ...
        <div className="bg-gray-800 rounded-xl shadow-lg p-4 md:p-8 max-w-4xl mx-auto mt-8">
          ...
          <ul className="list-disc list-inside text-gray-300 space-y-2 text-sm md:text-base">
            <li>SHA384 is a cryptographic hash function that produces a 384-bit (48-byte) hash value.</li>
            <li>It's part of the SHA-2 family and provides a good balance between security and performance.</li>
            <li>SHA384 is commonly used in digital signatures, integrity verification, and SSL/TLS protocols.</li>
            ...
            <li>SHA384 is more secure than SHA256 but slightly slower. It's a good choice for applications requiring very high security.</li>
          </ul>
        </div>
      </main>
      <Footer />
