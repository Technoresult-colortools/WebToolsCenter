...
const codingTools = [
  ...
  { name: 'MD5 Encrypt/Decrypt', href: '/tools/coding/md5-encrypt-decrypt', icon: faLock },
  { name: 'SHA1 Encrypt/Decrypt', href: '/tools/coding/sha1-encrypt-decrypt', icon: faLock },
