  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-gray-900 to-gray-800">
      ...
      <main className="flex-grow container mx-auto px-4 py-8">
        <h1 className="text-3xl md:text-4xl font-bold text-white mb-8 text-center">SHA512 Encrypt and Verify</h1>
        ...
        <div className="bg-gray-800 rounded-xl shadow-lg p-4 md:p-8 max-w-4xl mx-auto mt-8">
          ...
          <ul className="list-disc list-inside text-gray-300 space-y-2 text-sm md:text-base">
            <li>SHA512 is a cryptographic hash function that produces a 512-bit (64-byte) hash value.</li>
            <li>It's part of the SHA-2 family and provides the highest level of security among SHA-2 variants.</li>
            <li>SHA512 is commonly used in digital signatures, integrity verification, and password hashing.</li>
            ...
            <li>SHA512 offers the highest security in the SHA-2 family but may be slightly slower than SHA256 or SHA384. It's ideal for applications requiring maximum security.</li>
          </ul>
        </div>
      </main>
      <Footer />
