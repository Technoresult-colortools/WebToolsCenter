...
import { Upload, Copy, RefreshCw, FileText, Download, Zap, Info } from 'lucide-react'
      ...
      <main className="flex-grow container mx-auto px-4 py-8">
        ...
        <div className="bg-gray-800 rounded-xl shadow-lg p-4 md:p-8 max-w-4xl mx-auto mt-8">
          <section className="mb-6">
            <h2 className="text-2xl font-semibold text-white mb-2">About HTML Minifier</h2>
          ...
          <section className="mb-6">
            <h2 className="text-2xl font-semibold text-white mb-2">Key Features of HTML Minifier</h2>
          ...
          <section className="mb-6">
            <h2 className="text-2xl font-semibold text-white mb-2">How to Use HTML Minifier?</h2>
