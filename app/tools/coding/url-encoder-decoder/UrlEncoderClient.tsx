      ...
      <main className="flex-grow container mx-auto px-4 py-8">
        ...
        <div className="bg-gray-800 rounded-xl shadow-lg p-4 md:p-8 max-w-4xl mx-auto mt-8">
          <section className="mb-6">
            <h2 className="text-2xl font-semibold text-white mb-2">About URL Encoder/Decoder</h2>
          ...
          <section className="mb-6">
            <h2 className="text-2xl font-semibold text-white mb-2">Key Features of URL Encoder/Decoder</h2>
          ...
          <section className="mb-6">
            <h2 className="text-2xl font-semibold text-white mb-2">How to Use URL Encoder/Decoder?</h2>
            <ol className="list-decimal list-inside text-white space-y-2">
              ...
              <ul className="list-disc list-inside text-white ml-8">
