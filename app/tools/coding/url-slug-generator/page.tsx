      ...
      <main className="flex-grow container mx-auto px-4 py-8">
        ...
        <div className="bg-gray-800 rounded-xl shadow-lg p-6 md:p-8 max-w-4xl mx-auto">
          ...
          <ol className="list-decimal list-inside text-gray-300 space-y-2">
            ...
            <li>The slug will be automatically generated based on your settings.</li>
            <li>Customize your slug creation:</li>
            <ul className="list-disc list-inside ml-4 mt-2 space-y-1">
              <li>Choose a separator character (hyphen, underscore, dot, none, or enter a custom separator).</li>
              <li>Select the desired casing (lowercase, uppercase, or capitalize).</li>
              <li>Adjust the maximum length using the slider.</li>
              <li>Toggle the option to remove common stop words.</li>
              <li>Add custom replacements for specific characters or words.</li>
            </ul>
            <li>Use the "Randomize" button to generate a random input for testing.</li>
            <li>Click the "Copy" button to copy the generated slug to your clipboard.</li>
          </ol>
        </div>
