...
export default function TextToAsciiHexBinary() {
  ...
  return (
    <ToolLayout
      ...
      description="Text to ASCII/Hex/Binary Converter is a powerful tool that allows you to convert plain text into its ASCII, hexadecimal, and binary representations"
    >
